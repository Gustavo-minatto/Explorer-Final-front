...
import { InputAddPlate } from '../../Components/InputAddPlate'
...
export function AddPlate() {
    ...
    async function handleNewDish(event) {
        ...
        if (!name || !price || !type || !description || !photo) {
                ...
                <Form>
                    ...
                    <Section>
                        ...
                        <BiggerInput>
                            ...
                            <InputAddPlate placeholder="Ex.: Salada Ceasar" type="text" id='name' name='name' onChange={event => setName(event.target.value)} />
                        </BiggerInput>
                    ...
                    <Section>
                        ...
                        <ShorterInput>
                            ...
                            <InputAddPlate placeholder="R$ 00,00" type="number" id='price' name='price' onChange={event => setPrice(event.target.value)} />
                        </ShorterInput>
                    </Section>
