...
export function EditPlate({ dishId }) {
                ...
                <Form>
                    ...
                    <Section>
                        ...
                        <BiggerInput>
                            ...
                            <InputAddPlate value={name} type="text" id='name' name='name' onChange={event => setName(event.target.value)} />
                        </BiggerInput>
                    ...
                    <Section>
                        ...
                        <ShorterInput>
                            ...
                            <InputAddPlate value={price} type="number" id='price' name='price' onChange={event => setPrice(event.target.value)} />
                        </ShorterInput>
                    </Section>
